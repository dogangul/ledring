...
def ChasingEffect_Custom(prox,amb):
    ...
    if prox>1500:    
        ...
        LED_Color_Set(0,220*dim,20,0)
        LED_Color_Set(1,220*dim,20,0)
        LED_Color_Set(2,220*dim,20,0)
        LED_Color_Set(3,220*dim,20,0)
        LED_Color_Set(4,220*dim,20,0)
        LED_Color_Set(5,220*dim,20,0)
        LED_Color_Set(6,220*dim,20,0)
        LED_Color_Set(7,220*dim,20,0)
        LED_Color_Set(8,220*dim,20,0)
        LED_Color_Set(9,220*dim,20,0)
        LED_Color_Set(10,220*dim,20,0)
